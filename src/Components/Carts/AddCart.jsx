...
const AddCart = ({ cart, carts, setCats }) => {
    ...
    return (
        <div>
            <div className='flex items-center justify-between md:items-center gap-5 p-3 rounded-2xl shadow bg-violet-50'>
   ...
   w-10 h-10">
                ...
                <div className='block lg:hidden '>
                    <button onClick={() => handelRemove(carts)} className='font-bold text-red-600 hover:text-red-700 cursor-pointer ' >x</button>
                </div>
